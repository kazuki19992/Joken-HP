...
<span id="nav-drawer">
    ...
    <div id="nav-content">
        ...
        <?php
            // ログイン中か確認する
            if(!empty($_SESSION['member'])){
                echo '<a class="nv_Link tooltipped waves-effect waves-light" href="https://nu-joken.slack.com/" target="_blank" data-position="right" data-tooltip="ここから講習会の予約を行うことが可能です"> <i class="fas fa-chalkboard fa-fw"></i> 講習会予約システム</a>';
