<span id="nav-drawer">
    ...
    <div id="nav-content">
        ...
        <?php
            ...
            if(empty($_SESSION['member'])){
                // ログインしていない
                echo('<a class="nv_Link1 tooltipped waves-effect waves-light" href="./signin.php" data-position="right" data-tooltip="ここから一般会員のアカウント登録が可能です"> <i class="fas fa-user-plus fa-fw"></i> アカウント登録 </a>');
